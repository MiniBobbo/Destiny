...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Destiny", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Destiny";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Destiny", null, { width: 960, height: 540 });
